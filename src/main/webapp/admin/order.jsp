...
while(rs.next()){
	...
	String vechile = rs.getString(5);
	String address = rs.getString(6);
	String licence = rs.getString(7);
	String price = rs.getString(8);
	out.println("<tbody>");
	out.println("<tr>");
	out.println("<td>"+id+"</td>");
	out.println("<td>"+Custid+"</td>");
	out.println("<td>"+Fuel+"</td>");
	out.println("<td>"+Quantity+"</td>");
	out.println("<td>"+vechile+"</td>");
	out.println("<td>"+licence+"</td>");
	out.println("<td>"+price+"</td>");
	out.println("<form action='delete1.jsp' method = 'POST'>");
